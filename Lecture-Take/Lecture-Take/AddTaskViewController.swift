...
//              //Show user alert
//               displayErrorAlert(message: "An error occurred while saving data.")
//           }
//       }
//    
...
//        let vc = storyboard?.instantiateViewController(identifier: "viewallnotes") as! ViewController
//        vc.title = "Lecture - Take"
